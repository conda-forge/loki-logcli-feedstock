...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/loki-logcli-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/loki-logcli-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add loki-logcli
# for installing globally
pixi global install loki-logcli
```
...
It is possible to list all of the versions of `loki-logcli` available on your platform:
...
```
pixi search loki-logcli --channel conda-forge
```
